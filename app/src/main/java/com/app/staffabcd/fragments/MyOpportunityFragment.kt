...
import com.app.staffabcd.adapter.MyOpportunityAdapter
import com.app.staffabcd.adapter.OpportunityAdapter
import com.app.staffabcd.databinding.FragmentMyOpportunityBinding
...
class MyOpportunityFragment : Fragment() {


    lateinit var myOpportunityAdapter: MyOpportunityAdapter

    lateinit var binding: FragmentMyOpportunityBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMyOpportunityBinding.inflate(inflater, container, false)
...
//        binding.rvMyUsers.adapter = opportunityAdapter
            ...
            if (result) {
                try {
                    ...
                    if (jsonObject.getBoolean(Constant.SUCCESS)) {
                        ...
                        myOpportunityAdapter = MyOpportunityAdapter(requireActivity(),opportunity )
                        binding.rvMyUsers.adapter = myOpportunityAdapter
                    }else{
        ...
        }, requireActivity(), Constant.MY_TOOK_USERS, params, true)
    }
    ...
    private fun generatePDF() {
        ...
        // Draw the table data
        currentY += 50
        myOpportunityAdapter.opportunity.forEach() { user ->
            paint.color = Color.BLACK
